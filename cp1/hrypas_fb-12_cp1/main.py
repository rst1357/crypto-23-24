...
def main():
    ...
    LetterProbabliltySpace = GetProbability(Filename, AlphabetSpace)
    LetterEntropy = GetTextEntropy(LetterProbablilty)
    LetterEntropySpace = GetTextEntropy(LetterProbabliltySpace)
    ...
    H1Space = GetHn(LetterEntropySpace,1,AlphabetSpace)
